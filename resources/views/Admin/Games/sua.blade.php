                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9">
                                                @foreach($games->link_list as $item)
                                                    <input type="text" name="link[]" class="form-control" value="{{$item->link}}" id="row{{$item->id}}">
                                                    <p class="fa fa-trash-o anhquy" attr_data="{{$item->id}}" ></p>
                                                @endforeach
                                            <div id="password"></div>
                                            <p class="btn btn-danger add-form">Thêm form nhập</p>
                                        </div>
                                    </div>
                                    <div class="row form-group">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            ...
            $('.add-form').click(function(event) {
                i++
                var newInput = $('<input type="text" name="link[]" class="form-control" id="row'+i+'"  > <p class=" fa fa-trash-o anhquy" attr_data="'+ i +'"></p>');
